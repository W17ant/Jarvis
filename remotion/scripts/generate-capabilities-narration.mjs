 ...
 *
 *  10 scenes covering the full surface of what Jarvis can do. Each scene's
...
const SCENES = [
  { id: 'c_title',  text: "Jarvis can do a lot. Here's the tour." },
  { id: 'c_voice',  text: "Wake it with hey jarvis. Local Whisper transcribes, Qwen 2.5 thinks, Kokoro speaks. Sentence-level streaming gets the first reply in your ear in about a second. Saying stop cuts it off mid-sentence." },
  { id: 'c_vision', text: "Drop a shoot folder, ask what's in the latest shoot. Jarvis captions every keyframe, identifies the make and model, calls out angle and lighting. Search by description — find the front-grille hero on the Vulcan." },
  { id: 'c_edit',   text: "Voice-driven cinematic edits. Cut a 30-second teaser of yesterday's Aston shoot, vertical, closing card V-twelve beast. Jarvis scans, plans cuts, beat-syncs to a music track, applies your brand tail-card, and lands a finished MP4." },
  ...
  { id: 'c_outro',  text: "Seventy-six tools, all exposed through the Model Context Protocol. Claude Desktop, Cursor, Continue — drive the same kiosk from anywhere. Jarvis. Built for the agency that lives and breathes automotive." },
];
